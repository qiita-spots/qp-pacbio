...
def runner(artifact_id, out_dir, job_id):
    ...
    jid5 = sbatch(['sbatch', '--parsable', '--dependency', f'aftercorr:{jid4}', f'{out_dir}/step-5/step-5.slurm'])
    jid6 = sbatch(['sbatch', '--parsable', '--dependency', f'aftercorr:{jid5}', f'{out_dir}/step-6/step-6.slurm'])
    jid7 = sbatch(['sbatch', '--parsable', '--dependency', f'aftercorr:{jid6}', f'{out_dir}/step-7/step-7.slurm'])

    print(f'Submitted jobs: {jid0}, {jid1}, {jid2}, {jid3}, {jid4}, {jid5}, {jid6}, {jid7}')
