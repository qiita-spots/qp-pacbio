...
This script was modified to take in
lingenome_mopp.py
-i indir
-m metadata_filename_to_genome_id
--gap N*20
"""
...
description = """example:
  lingemome.py -i multi_fna.gz_dir -o output.fna --concat --gap N*20 \\
    --filt plasmid,phage
"""

epilog = """This script mimics the behavior of BURST's "lingeome" utility,
with more controls.
"""
...
def parse_args():
    ...
    arg('-m', '--metadata', required=True,
        help='tab-delimited mapping between genome filenames '
             '(without .fna) and genome id')
