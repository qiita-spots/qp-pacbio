...
class PacWoltkaSynDNATests(PacBioTests):
    def test_syndna(self):
        ...
        exp_main = [
            ...
            "counts=`awk '{sum += $NF} END {print sum}' ${sn_folder}/${sample_name}.txt`\n",
            'if [[ "$counts" == "0" ]]; then\n',
            ...
            "samtools view -bS -@ 8.0 ${out_folder}/${sample_name}_no_plasmid.fastq | samtools sort -@ 8.0 -O bam -o ${out_folder}/${sample_name}_GCF_000184185_sorted.sam\n",
